...
|---|---:|---:|
| Lighthouse Performance | 55 | **97** |
| Lighthouse Accessibility | 85 | **100** |
| Lighthouse Best Practices | 71 | **100** |
| Lighthouse SEO | 92 | **100** |
| Bytes transferred (home page) | 9.0 MB | **0.2 MB** |
| Network requests | 133 | **18** |
| Largest Contentful Paint | 36.5 s | **2.3 s** |
...
| **Content rendered twice** (separate desktop and mobile copies in the DOM — 12–44 duplicated blocks per page, "Read Full Biography" 30× on the home page) | Screen readers announce everything twice; doubles page weight | Each block rendered once; layout is responsive via CSS. 0 duplicates |
...
| **69 of 84 home-page images have empty `alt`** | Most are content images, invisible to assistive tech | 6 images, all decorative and correctly marked |
| **9 MB / 133 requests** on the home page, 19 inline scripts | Slow on mobile networks; inline scripts prevent a strict Content-Security-Policy | 0.2 MB / 18 requests, 0 inline scripts, strict CSP |
...
the official `.gov` banner, skip link, and landmark structure.
